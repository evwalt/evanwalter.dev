...
export function FooterLinksGroup({ addClassNames = '', children }: FooterLinksGroupProps) {
  return (
    <div className={`${addClassNames} flex flex-col items-center justify-start gap-y-4`}>
      {children}
    </div>
  );
}
