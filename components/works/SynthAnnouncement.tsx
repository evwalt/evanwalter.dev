...
export default function SynthAnnouncement({ addClassNames }: AnnouncementProps) {
  ...
  return (
    <Work addClassNames={addClassNames}>
      ...
      <p>
        As a musician (mainly drums) and someone who loves music, creating this app was quite fun
        for me. I plan to build onto it in the future!
      </p>
